<head>
    ...
    <link href="{{url('public/backend/assets/plugins/Drag-And-Drop/dist/imageuploadify.min.css') }}" rel="stylesheet" />
	<link href="{{url('public/backend/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet"/>
    ...
    <link href="{{url('public/backend/assets/plugins/datatable/css/dataTables.bootstrap5.min.css') }}" rel="stylesheet" />
	...
	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="{{url('public/backend/assets/css/dark-theme.css') }}"/>
	<link rel="stylesheet" href="{{url('public/backend/assets/css/semi-dark.css') }}"/>
	<link rel="stylesheet" href="{{url('public/backend/assets/css/header-colors.css') }}"/>
    <link href="{{url('public/backend/assets/plugins/fancy-file-uploader/fancy_fileupload.css') }}" rel="stylesheet" />
