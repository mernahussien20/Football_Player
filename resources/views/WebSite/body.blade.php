...
<!--                <img src="{{url('public/frontend/assets/img/logo.png')}}" class="img-fluid rounded animated zoomIn" alt=""  style="width: 200px;>-->
<!--            </div>-->
...
<!--                {{-- <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-4 animated bounceInDown">Welcome to CaterServ</small> --}}-->
                <!--<h1 class="display-1 mb-4 animated bounceInDown">اختبارات <span class="text-primary">SPORTS</span>AGENCY</h1>-->
...
<!--                {{-- <a href="{{ route('players.create')}}" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft">تسجيل لاعب</a>-->
<!--                {{--  <a href="{{ route('inquirys') }}" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">استعلام</a> --}}-->

                <!--<a href="{{ route('players.create')}}" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft" style="margin-right: 20px;">تسجيل لاعب</a>-->
                <!--<a href="{{ route('inquirys') }}" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">استعلام</a>-->
                
<!--                                <div class="d-flex justify-content-center">-->
<!--                    <button class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft" style="margin-right: 20px;">-->
<!--                        <a href="{{ route('players.create')}}" style="color: white; text-decoration: none;">تسجيل لاعب</a>-->
<!--                    </button>-->
<!--                    <button class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">-->
<!--                        <a href="{{ route('inquirys') }}" style="color: white; text-decoration: none;">استعلام</a>-->
<!--                    </button>-->
<!--                </div>-->
...
<!--</div>-->
  ...
  <div class="col-lg-5 col-md-12" style="position: absolute; top: 0; left: 0; padding: 10px;">
                <img src="{{url('public/frontend/assets/img/Untitled-1.png')}}" class="img-fluid rounded animated zoomIn" alt="" style="width: 150px;">
            </div>
<div class="container-fluid bg-light py-6 my-6 mt-0 d-flex justify-content-center align-items-center" style="min-height: 100vh;">
...
{{-- <div class="d-flex align-items-center justify-content-center " style="margin: 20px; padding: 10px 20px;">
    <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="{{ route('players.create') }}">تسجيل </a>
    <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="{{ route('inquirys') }}">استعلام </a>
</div> --}}
@endsection
